        ...
        <div className="m-8 md:mx-12 lg:mx-16">
            ...
            <div className="mb-14">
                <h1 className="font-bold text-3xl text-center md:text-left">
                    <span className="text-blue-600">Alumni</span> Overview
                </h1>
            ...
            <div className="mt-10">
                <h1 className="font-bold text-3xl text-center md:text-left">
                    <span className="text-blue-600">About VC</span> Overview
                </h1>
            ...
            <div className="mb-12 mt-14">
                <h1 className="font-bold text-3xl text-center md:text-left">
                    <span className="text-blue-600">About BU</span> Overview
                </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 px-4 md:px-18 lg:px-8 ">
                <div className="bg-blue-50 text-white p-6 rounded shadow-md">
                    <h2 className="text-blue-600 text-xl font-bold mb-2">Vision</h2>
                ...
                <div className="bg-blue-50 text-white p-6 rounded shadow-md">
                    <h2 className="text-blue-600 text-xl font-bold mb-2">Mission</h2>
                    <p className="text-black text-justify">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure
                        sapiente voluptates nisi consequuntur distinctio impedit
            ...
            <div className="mt-20  grid grid-cols-1  md:grid-cols-2 gap-1">
                ...
                <div className=" border-2 border-gray-300 p-4 rounded-md shadow-md ">  
                    <h2 className="text-blue-600 font-bold">Message From Head, P.G. Department of Computer Science </h2>
                    <p>
                        ...
                        Warm regards,
                        <br/><span className='font-bold'>Dr.Sushant Kumar Das</span></p>
                </div>
            ...
            <div className=" max-w-3xl mx-auto mt-16">
                <h2 className="text-lg font-bold mb-6 ml-2 text-blue-600 " >Impact Message From Alumni</h2>
